...
SOCIAL_AUTH_URL_LOGIN_REDIRECT_URL = '/'
SOCIAL_AUTH_URL_LOGIN_ERROR_URL = '/login-error/'
SOCIAL_AUTH_VK_OAUTH2_SCOPE = ['email']
SOCIAL_AUTH_VK_EXTRA_DATA = [('email', 'email')]
SOCIAL_AUTH_NEW_USER_REDIRECT_URL = '/logger-in/'
SOCIAL_AUTH_NEW_USER_MODEL = 'core.User'
